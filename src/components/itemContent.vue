<template>
  <div class="item-content">
    ...
    <!--<div v-for="(item, index) in itemList[itemId].topic_answer">-->
    <!--<el-radio v-model="radio7" :label="index" border>{{ item.answer_name }}</el-radio>-->
    <!--</div>-->
    <p>{{ choosedScore }}</p>
    <p>{{ score }}</p>
...
<script>
  // import itemList from '../store/mock.js'
